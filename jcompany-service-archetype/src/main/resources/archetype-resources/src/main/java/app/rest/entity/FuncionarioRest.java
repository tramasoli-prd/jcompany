...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.app.rest.entity;
...
import ${package}.app.model.entity.funcionario.DependenteEntity;
...
import ${package}.app.model.service.FuncionarioService;
...
public class FuncionarioRest extends PlcAbstractEntityRest<Long, FuncionarioEntity, Object> {
	...
	public Response getFoto(@PathParam("id") Long idFoto) {
		...
		response.header("Content-Disposition", "inline; filename=${symbol_escape}""+fotoEntity.getNome()+"${symbol_escape}"; size=${symbol_escape}""+fotoEntity.getTamanho()+"${symbol_escape}"");
